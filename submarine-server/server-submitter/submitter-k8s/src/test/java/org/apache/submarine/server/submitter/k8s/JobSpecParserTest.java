...
public class JobSpecParserTest {
  ...
  public void testValidPyTorchJobSpec() throws IOException,
    ...
    // framework name
    String expectedFramework = jobSpec.getLibrarySpec().getName();
    String actualFrameworkName = JobLibrarySpec.SupportedMLFramework.PYTORCH.getName();
  ...
  public void validateReplicaSpec(JobSpec jobSpec,
      PyTorchJob pyTorchJob, PyTorchJobReplicaType type) {
    MLJobReplicaSpec mlJobReplicaSpec = pyTorchJob.getSpec().
        getReplicaSpecs().get(type);
